...
function showResults() {
  ...
  if (pct >= 60) {
    ...
    miniGameBtn.textContent = Math.random() > 0.5 ? 'Play 1-Minute Breakout' : 'Play 1-Minute Pong';
...
function startMiniGame() {
  const gameType = miniGameBtn.textContent.includes('Breakout') ? 'breakout' : 'pong';
  resultScreen.classList.add('hidden');
